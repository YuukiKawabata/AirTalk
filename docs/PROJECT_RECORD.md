...
最終更新: 2026-08-01 / 状態: **1.2 公開中 / 1.2.1(8) 審査待ち**
...
| 現在のビルド | **1.2(7)** が公開中 / **1.2.1(8)** は審査待ち（手動公開） |
...
16. **1.2.1 審査提出** — `1.2.1(8)` をアップロード。スクリーンショットと日本語メタデータを引き継ぎ、物理端末2台の審査手順を登録して手動公開で提出。
...
```
現在: 1.2(7) 公開中 / 1.2.1(8) 審査待ち
   ↓
審査承認後、物理 iPhone 2台で最終確認
   ↓
App Store Connect で手動公開
```
